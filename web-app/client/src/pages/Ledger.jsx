        ...
        <div className="container-fluid">
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
                <div>
                    <h2 className="mb-1 text-white">
                        <i className="bi bi-book me-2" style={{ color: 'var(--accent-primary)' }}></i>
                        Libro Mayor
                    </h2>
            ...
            <div className="row g-3 mb-4">
                <div className="col-md-3">
                    <div className="card glass-panel border-primary border-opacity-25 h-100">
                        <div className="card-body">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small className="text-white-50">Cuentas con Movimientos</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-3">
                    <div className="card glass-panel border-success border-opacity-25 h-100">
                        <div className="card-body">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small className="text-white-50">Total Debe</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-3">
                    <div className="card glass-panel border-danger border-opacity-25 h-100">
                        <div className="card-body">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small className="text-white-50">Total Haber</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="col-md-3">
                    <div className="card glass-panel border-info border-opacity-25 h-100">
                        <div className="card-body">
                            <div className="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small className="text-white-50">Total Movimientos</small>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            {loading || detailLoading ? (
                <div className="card glass-panel border-secondary shadow-sm">
                    <div className="card-body text-center py-5">
                        ...
                        <p className="mt-3 text-white-50 mb-0">Cargando datos...</p>
                    </div>
                </div>
                ...
                <div className="card glass-panel border-secondary shadow-sm">
                    <div className="card-header border-secondary text-white" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                        <div className="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <small className="text-white-50">{accountDetail.movements.length} movimientos</small>
                            </div>
                            <button
                                className="btn btn-outline-light btn-sm"
                    ...
                    <div className="card-body p-0">
                        {/* Opening Balance */}
                        {dateStart && (
                            <div className="px-4 py-3 border-bottom border-secondary" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
                                <div className="d-flex justify-content-between align-items-center">
                        ...
                        <div className="table-responsive">
                            <table className="table table-dark table-hover mb-0 border-secondary" style={{ backgroundColor: 'transparent' }}>
                                <thead style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                                    <tr>
                                        <th className="border-secondary text-white-50" style={{ width: '12%' }}>Fecha</th>
                                        <th className="border-secondary text-white-50" style={{ width: '10%' }}>Ref.</th>
                                        <th className="border-secondary text-white-50" style={{ width: '38%' }}>Glosa</th>
                                        <th className="text-end border-secondary text-white-50" style={{ width: '13%' }}>Debe</th>
                                        <th className="text-end border-secondary text-white-50" style={{ width: '13%' }}>Haber</th>
                                        <th className="text-end border-secondary text-white-50" style={{ width: '14%' }}>Saldo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {accountDetail.movements.length === 0 ? (
                                        ...
                                        accountDetail.movements.map((m, idx) => (
                                            <tr key={idx} className="border-secondary">
                                                <td className="border-secondary text-white">{formatDate(m.date)}</td>
                                                ...
                                                <td className="text-truncate border-secondary text-white" style={{ maxWidth: '300px' }}>
                        ...
                        {/* Totals Footer */}
                        <div className="px-4 py-3 border-top border-secondary" style={{ backgroundColor: 'rgba(255, 255, 255, 0.02)' }}>
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="d-flex gap-4">
                                        <div>
                                            <small className="text-white-50 d-block">Total Debe</small>
                                            <strong className="text-white">{formatCurrency(accountDetail.total_debit)}</strong>
                                        </div>
                                        <div>
                                            <small className="text-white-50 d-block">Total Haber</small>
                                            <strong className="text-white">{formatCurrency(accountDetail.total_credit)}</strong>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-md-6 text-end">
                                    <small className="text-white-50 d-block">Saldo Final</small>
                                    <span className="fs-5">
                    ...
                    <div className="card-body p-0">
                        <div className="table-responsive">
                            <table className="table table-dark table-hover mb-0 align-middle border-secondary" style={{ backgroundColor: 'transparent' }}>
                                <thead style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                                    <tr>
                                        <th className="border-secondary" style={{ width: '40px' }}></th>
                                        <th className="border-secondary text-white-50" style={{ width: '12%' }}>Código</th>
                                        <th className="border-secondary text-white-50">Nombre de Cuenta</th>
                                        ...
                                        <th className="text-end border-secondary text-white-50" style={{ width: '15%' }}>Saldo</th>
                                    </tr>
                                </thead>
                                <tbody>
                                            ...
                                            <React.Fragment key={account.id}>
                                                ...
                                                >
                                                    <td className="text-center border-secondary">
                                                        <i className={`bi bi-chevron-${expandedRows[account.id] ? 'down' : 'right'} text-white-50`}></i>
                                                    </td>
                                                    <td className="border-secondary">
                                                        <span className="badge bg-dark bg-opacity-50 text-white border border-secondary">
                                                            {account.code}
                                                        </span>
                                                    </td>
                                                    <td className="border-secondary">
                                                        <div className="fw-semibold text-white">{account.name}</div>
                                                        <small className="text-white-50">{account.type}</small>
                                                    </td>
                                                    <td className="text-end border-secondary">
                                                ...
                                                {expandedRows[account.id] && (
                                                    <tr>
                                                        <td colSpan="6" className="p-0 border-secondary" style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
                                                            <div className="p-3 border-bottom border-secondary">
                                                                <table className="table table-sm table-dark table-borderless mb-0 small" style={{ backgroundColor: 'transparent' }}>
                                                                    ...
                                                                    <tbody>
                                                                        {account.details && account.details.length > 0 ? (
                                                                            ...
                                                                            <tr>
                                                                                <td colSpan="5" className="text-center text-white-50 fst-italic py-2">
                                                                                    Sin movimientos
                                                                                </td>
                                                                            </tr>
                                                                        )}
                                ...
                                {filteredLedger.length > 0 && (
                                    <tfoot className="border-top border-secondary">
                                        <tr className="fw-bold" style={{ backgroundColor: 'rgba(255,255,255,0.05)' }}>
                                            <td colSpan="3" className="text-end text-white border-secondary">TOTALES:</td>
                                            <td className="text-end text-success border-secondary">
                                                {formatCurrency(stats.totalDebit)}
                                            </td>
                                            <td className="text-end text-danger border-secondary">
                                                {formatCurrency(stats.totalCredit)}
                                            </td>
                                            <td className="text-end text-white border-secondary">
                                                                    ...
                                                                    <div className="p-2">
                                                                        {data.groups.slice(0, 5).map((g, gi) => (
                                                                            <div key={gi} className="mb-4">
                                                                                <h6 className="fw-bold border-bottom border-secondary pb-1 text-white px-2 mt-2">{g.title}</h6>
                                                                                <table className="table table-dark table-striped table-sm small mb-0 border-secondary" style={{ backgroundColor: 'transparent' }}>
                                                                                    <thead style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                                                                                        <tr>{columns.map((c, ci) => <th key={ci} className="px-2 py-1 border-secondary text-white-50">{c.header}</th>)}</tr>
                                                                                    </thead>
                                                                                    <tbody>
                                                                                        {g.data.slice(0, 10).map((r, ri) => (
                                                                                            <tr key={ri} className="border-secondary">
                                                                                                {columns.map((c, ci) => <td key={ci} className="px-2 py-1 text-nowrap border-secondary text-white">{r[c.field]}</td>)}
                                                                                            </tr>
                                                                                        ))}
                                                                                    </tbody>
                                                                                </table>
                                                                        ...
                                                                        {data.groups.length > 5 && (
                                                                            <div className="text-center text-white-50 fst-italic mt-2 border-top border-secondary pt-2">
